...
# Output
set output "/home/leo/hypatia/ECE227/pdf/ecdf_max_rtt_to_min_rtt_slowdown.pdf"
...
# Axes ranges
set xrange [1:4]       # Explicitly set the x-range [lower:upper]
...
plot    "/home/leo/hypatia/ECE227/rtt/starlink_550_isls_plus_grid_ground_stations_top_100_algorithm_free_one_only_over_isls/1000ms_for_200s/rtt/data/ecdf_pairs_max_rtt_to_min_rtt_slowdown.txt" using ($1):($2) title "Baseline"  with steps ls 3, \
        "/home/leo/hypatia/ECE227/rtt_delete_50/starlink_550_isls_plus_grid_ground_stations_top_100_algorithm_free_one_only_over_isls/1000ms_for_200s/rtt/data/ecdf_pairs_max_rtt_to_min_rtt_slowdown.txt" using ($1):($2) title "50 Satellites Removed"  with steps ls 1, \
        "/home/leo/hypatia/ECE227/rtt_delete_100/starlink_550_isls_plus_grid_ground_stations_top_100_algorithm_free_one_only_over_isls/1000ms_for_200s/rtt/data/ecdf_pairs_max_rtt_to_min_rtt_slowdown.txt" using ($1):($2) title "100 Satellites Removed"  with steps ls 2
