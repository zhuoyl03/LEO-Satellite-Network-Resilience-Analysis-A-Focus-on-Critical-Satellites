...
from config import LEGACY_STARLINK_SHELL_NAME, PROJECT_RESULT_GENERATED_DIR, PROJECT_NETWORKS_DIR
...
output_data_dir = PROJECT_RESULT_GENERATED_DIR / "end_to_end_path_plot"
