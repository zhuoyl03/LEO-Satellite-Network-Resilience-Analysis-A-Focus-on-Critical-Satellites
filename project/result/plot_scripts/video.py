...
from config import PROJECT_RESULT_GENERATED_DIR
...
def render_default_video():
    ...
    image_folder = PROJECT_RESULT_GENERATED_DIR / "end_to_end_path_plot"
    output_video_path = PROJECT_RESULT_GENERATED_DIR / "1593_to_1590_Video.mp4"
